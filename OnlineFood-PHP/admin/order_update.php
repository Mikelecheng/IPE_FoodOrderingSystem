...
$sql=mysqli_query($db,"update user_orders set status='$status' where uo_id='$form_id'");
$sql1=mysqli_query($db,"update order_items set status='$status' where uo_id='$form_id'");
